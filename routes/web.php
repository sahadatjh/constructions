...
Route::get('/ready-desin', [HomeController::class, 'readyDesign'])->name('ready.design');
Route::get('/ready-desin/single', [HomeController::class, 'productSingle'])->name('product.single');
